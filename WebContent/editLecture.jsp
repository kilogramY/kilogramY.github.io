...
<script>
	...
	function doUpdate() {
		document.lectureInfo.target='_self';
		document.lectureInfo.action='updateLecture';
		document.lectureInfo.submit();
	}
</script>
<style>	
			...
			<div class="content">
				<table>
					<tr>
						...
						<td class="selected"><h2>강의<br>수정</h2></td>
					</tr>
				</table>
				<%
				...
				<input type="text" name="from" style="display:none;" value="editLecture.jsp">
				...
				<input type="text" name="from" style="display:none;" value="editLecture.jsp">
					...
					<hr>
					수정할 부분의 내용을 새로 입력한 후 수정완료 버튼을 누르면 강의 정보가 수정됩니다.<br><br>
					전공: <input type="text" name="major" value="<%=smajor%>"><br><br>
					강의명: <input type="text" name="lecName" value="<%=lecName%>"><br><br>
					교수명: <input type="text" name="professor" value="<%=professor%>"><br><br>
					요일: 
					<input type="text" name="day" value="<%=day%>"><br><br>
					교시: <input type="text" name="time" size="10" value="<%=time%>"> ex) x,x,x<br><br>
					캠퍼스: 
					<input type="text" name="campus" value="<%=campus%>">
					강의실: 
					<input type="text" name="classroom" value="<%=classroom%>"><br><br>
